...
namespace Lemony.SystemInfo
{
    ...
    public class SystemInfo
    {
        ...
        List<PerformanceCounter> _perFormanceCountArry = new List<PerformanceCounter>();
        #region AIP声明 
        ...
        public float CpuLoad
        {
            get
            {
                ...
                //float sum=0;
                return _perFormanceCountArry[0].NextValue();

                //foreach (var item in _perFormanceCountArry)
                //{
                //    sum+= item.NextValue();
                //}
                //return sum/ _perFormanceCountArry.Count;
            }
        }
        public void InitCpuCore()
        {
            ...
            {
                var cuoLoad = new PerformanceCounter("Processor", "% Processor Time", "_Total");
                float m=  cuoLoad.NextValue();
                _perFormanceCountArry.Add(cuoLoad);
            }
        }
        public float SingleCpuLoad()
        {
            return 0;
